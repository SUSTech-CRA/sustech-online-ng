  ...
  <main class="bus-detail" :lang="busLanguage === 'zh' ? 'zh-CN' : 'en'">
    <div class="detail-head">
      ...
      <div class="head-actions">
        <a class="plain-button" href="/transport/bustimer_v2.html">{{ label('home') }}</a>
...
.route-stops .vehicle-marker.between { top: .1rem; background: color-mix(in srgb, #f7a600 18%, var(--bus-v2-bg)); }
