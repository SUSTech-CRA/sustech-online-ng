...
本文面向 2020 级新生撰写。通用学习方法可继续参考，但课程设置、教材、考试、分级方式和入学安排不能用于推断当前规则。当前通知请查看[南方科技大学迎新网](https://welcome.sustech.edu.cn/)、本人培养方案和教学工作部邮件。
...
以下考试内容只记录 **2018—2020 年**的情况，不适用于推断当前安排。如当年设置分级或选拔考试，科目、时间、参加范围和课程衔接以迎新网、教学工作部邮件及校内通知为准。
...
- [学习制度与信息（2020 历史资料）](./info-on-study.md)
